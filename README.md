...
- To create clear and interactive dashboards for quick decision-making.
...
- **Orders Data** – Sales transactions including date, product, quantity, and price.
- **Product Category** – Details about product types and pricing.
- **Sales Summary** – Aggregated metrics used for dashboard creation.
...
- **Microsoft Excel**
  ...
  - Data Visualization with Pivot Charts and Interactive Dashboards.
- **Excel Dashboard**
...
- **Seasonal Trends:** Detected peak sales months and low-performing periods.
- **Channel Performance:** Compared online vs. offline sales effectiveness.
...
- Derive actionable insights from sales data to support business decisions.
